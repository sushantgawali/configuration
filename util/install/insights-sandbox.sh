...
if [ -n "$OPENEDX_RELEASE" ]; then
  ...
  CONFIG_VER="appsembler/feature/insights"
fi
...
##
cd /var/tmp/configuration/playbooks && sudo ansible-playbook -c local ./edx_sandbox.yml -i "localhost," $EXTRA_VARS -e @/edx/app/edx_ansible/server-vars.yml
